...
export default function Contact() {
  return (
    <>
      <Helmet>
        <title>Contact | Yves David</title>

        <meta
          name="description"
          content="Parlons de votre projet web. Demandez un devis ou échangeons sur la meilleure solution pour votre activité."
        />

        <meta
          name="keywords"
          content="contact développeur web, devis site internet, freelance web France, création site web contact"
        />
      </Helmet>
